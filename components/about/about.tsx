...
export default function About(){
    ...
    <div className="sm:min-h-screen mb-40 sm:mb-16">
        <div ref={topbox} className="w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 bg-blue-400"></div>
<div  className="mt-8 mb-8 sm:mb-12 px-4">
    <div className=' text-white rounded-3xl p-6 sm:p-10 w-full max-w-5xl border bg-zinc-900'>
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-6">About Me</h1>
...
<div ref={buttombox} className=" bg-blue-400 absolute right-4 sm:right-10 w-16 h-16 sm:w-24 sm:h-24">
      </div>
      </div>
    )
}