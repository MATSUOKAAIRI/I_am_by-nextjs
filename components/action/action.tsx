...
return(<div className="sm:min-h-screen mb-40 sm:mb-16">
<div ref={topbox} className="w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 bg-purple-400"></div>
<div className="flex items-center justify-end mb-8 mt-8 right-0 sm:mb-12 px-4"> 
    <div className=' text-white rounded-3xl p-6 sm:p-10 w-full max-w-5xl bg-zinc-900 border'>
        <div className="flex">
            ...
            <h1 className="md:text-6xl text-3xl font-bold mb-6">(参加イベント)</h1>
        </div>
...
<div ref={buttombox} className=" bg-purple-400 absolute right-0 w-16 h-16 ms:w-24 ms:h-24">
      </div>
      </div>    
)
};